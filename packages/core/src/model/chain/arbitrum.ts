...
const arbitrumSepoliaExplorerUrl = 'https://sepolia.arbiscan.io/'
...
export const ArbitrumSepolia: Chain = {
  ...
  isTestChain: false,
  isLocalChain: false,
  multicallAddress: '0x10b40939bdf250c31c624d1f9642BE44771e69B1',
  ...
  blockExplorerUrl: arbitrumSepoliaExplorerUrl,
  getExplorerAddressLink: getAddressLink(arbitrumSepoliaExplorerUrl),
  getExplorerTransactionLink: getTransactionLink(arbitrumSepoliaExplorerUrl),
}
